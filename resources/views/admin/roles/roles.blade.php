...
@section('content')
    ...
    <div class="container" style="margin-left:5%; ">
        ...
        <!-- Add role form -->
        <form id="addRoleForm" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('roles.store') }}"
            method="POST">
            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="row">
                                            <div class="form-check me-3 me-lg-5">
                                                <input class="checkbox form-check-input" type="checkbox" id="all-leave">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="row">
                                            <div class="form-check me-3 me-lg-5">
                                                <input class="checkbox form-check-input" type="checkbox" id="all-report">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="row">
                                            <div class="form-check me-3 me-lg-5">
                                                <input class="checkbox form-check-input" type="checkbox" id="all-notice">
                                                <label class="form-check-label" for="all-announcement">
                                                    Select all
                                                </label>
                                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <div class="row">
                                            <div class="form-check me-3 me-lg-5">
                                                <input class="checkbox form-check-input" type="checkbox" id="all-other">
                                                <label class="form-check-label" for="all-announcement">
                                                    Select all
                                                </label>
                                            </div>
