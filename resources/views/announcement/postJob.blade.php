...
@section('content')
    ...
    <div class="container p-2">
        <div class="col-6">
            <h3 class="p-2 mb-3">Dashboard>announcement><span class="text-primary">Jobss</span> </h3>
        </div>
        <form class="mt-2 ps-5" method="POST" action="{{ route('admin.post.job') }}">
                ...
                <div class="col-4 row mb-3">
                    ...
                    <div>
                        <input id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror"
                            name="start_date" autocomplete="current-date" autofocus>
                ...
                <div class="col-4 row mb-3">
                    ...
                    <div>
                        <input id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror"
                            name="end_date" autocomplete="current-date" autofocus>
            ...
            <button type="submit" class="btn btn-primary ms-4" style="width:6rem;"> {{ __('Post') }}</button>
        </form>
    </div>
@endsection
