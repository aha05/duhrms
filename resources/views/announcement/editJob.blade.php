...
@section('content')
    ...
    <div class="container p-2">
        ...
        <form class="mt-2 ps-5" method="POST" action="{{ route('admin.job.update', $postedJob) }}">
            @csrf
            @method('PUT')
            <input type="text" name="postId" value="{{ $postedJob->id }}" style="display: none">
            <div class="col-8 row mb-3">
                <label for="title" class="form-label">{{ __('Title') }}</label>

                <div>
                    <input id="title" type="text" class="form-control @error('title') is-invalid @enderror"
                        name="title" value="{{ $postedJob->title }}" autocomplete="title" autofocus >
                ...
                <div class="col-4 row mb-3">
                    ...
                    <div>
                        <input id="start_date" type="date" class="form-control @error('start_date') is-invalid @enderror"
                            name="start_date" autocomplete="current-date" value="{{ $postedJob->start_date->format('Y-m-d') }}"  autofocus >
                ...
                <div class="col-4 row mb-3">
                    ...
                    <div>
                        <input id="end_date" type="date" class="form-control @error('end_date') is-invalid @enderror"
                            name="end_date" value="{{ $postedJob->end_date->format('Y-m-d') }}" autocomplete="current-date" autofocus>
            ...
            <div class="col-8 row mb-3">
                ...
                <div>
                    <textarea rows="5" id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                        name="description" autocomplete="description" autofocus >{{ $postedJob->description}}</textarea>
                ...
                <button type="submit" class="btn btn-primary ms-4">Update</button>
